      ...
      implicit none
C----------
C  **REGENT--TT   DATE OF LAST REVISION:   03/23/12
C----------
...
C             ARE AVERAGED.
C
C  NOTE: UT AND CR LOGIC IS BASED ON A 10-YEAR REGYR
C----------
      EXTERNAL RANN
      CHARACTER SPEC*2
      LOGICAL DEBUG,LESTB,LSKIPH,CIVAR,UTVAR,TTVAR
C
      INTEGER I,I1,I2,I3,ICRK,IICR,IITRE,IS,IPCCF,IREFI,ISPC
...
C
      ...
      REAL B1,B2,BACHLO,BACON,BAJ,BAL,BANEXT(10),BARK,BAYR,BBAL
      ...
      REAL DGMX,DIAM(MAXSP),DK,DKK,DLESS3,DNEW,EDH,FNT,DGMAX(MAXSP)
      REAL H,H1,H2,HAT3,HHT1(MAXSP),HHT2(MAXSP),HITE1,HITE2,HK,HLESS4
      REAL HSIGMA,HTG1,HTGR,HTGR1,HTGRL,HTMAX,HTMAX2
      REAL P,P2,P3,P4,PCTRED,PN,POTHTG,PPCCF,PS
      REAL R,RAN,RCR,RDJ,RDNEXT(10),REGYR,RELH,RELSDI,RELSI
      REAL RHGL(3),RHHAB(6,MAXSP),RHLH(MAXSP)
      REAL RHSC(MAXSP),RSAB0,RSAB1,RSAB2,RSIMOD
      REAL SCALE,SCALE2,SCALE3
      REAL SHI(MAXSP),SI,SITAGE,SITHT,SJ,SLO(MAXSP)
      REAL SNP,SNX,SNY,STDDEV
...
C UT ESTIMATES ARE 10-YEAR ESTIMATES AND THUS ADJUSTED BY FINT/10
C----------
      IF(CIVAR)THEN
...
C----------
      ...
      END SELECT
C----------
C  COMPUTE HT GROWTH AND AGE FOR ROCKY MTN MAPLE;
C  USE APSPEN EQN FROM WAYNE SHEPPARD RMS.
C----------
      IF(ISPC .EQ. 14)THEN
