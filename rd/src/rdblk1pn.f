      ...
      implicit none
C----------
C  **RDBLK1-PN     LAST REVISION:  08/27/14
C----------
C
C  Purpose :
...
C.... model.
C....
C.... The following IRTSPC is used with variant PN :
C.... PN has 39 species.
C RD
C INDX SP   SPECIES LIST FOR PACIFIC COAST VARIANT
C
...
C               SHASTA RED FIR
C   8  ES   6 = SITKA SPRUCE (SS)            PICEA SITCHENSIS
