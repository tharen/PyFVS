      ...
      IMPLICIT NONE
C----------
C  $Id: sumhed.f 767 2013-04-10 22:29:22Z rhavis@msn.com $
C----------
...
C----------
    ...
    1   FORMAT(/T20,'CR-',A2,' FVS METRIC VARIANT -- RV:',A10/)
      ELSE
        WRITE(JOSCRN,2) VVER(:3),REV
    2   FORMAT(/T20,A3,' FVS METRIC VARIANT -- RV:',A10/)
      ENDIF
C
   ...
   11 FORMAT (/T17,'SUMMARY STATISTICS (BASED ON TOTAL STAND AREA)'
     ...
     >  ' CU  M',/, T7,'TREES',9X,'TOP',6X,'TOTAL TREES TOTAL MERCH',
