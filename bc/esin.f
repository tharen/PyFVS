      ...
      IMPLICIT NONE
C----------
C  $Id: esin.f 767 2013-04-10 22:29:22Z rhavis@msn.com $
C----------
C
...
C
     ...
     &       3100,3200,3300,3400,3500,3600,3700,1000,3800,3900),NUMBER
 1000 CONTINUE
C
...
C
      ...
      IMET = 0
      IF(LNOTBK(1)) IDT  = IFIX(ARRAY(1))
      IF(LNOTBK(2)) IYR1 = MAX(0,IFIX(ARRAY(2)))
      IF(LNOTBK(3)) IMET = MAX(1,IFIX(ARRAY(3)))
      ARRAY(2) = FLOAT(IYR1)
      ARRAY(3) = FLOAT(IMET)

C     METHOD= >0; READ EXTERNAL PROGRAM THAT WILL GENERATE PLANT COMMANDS
 ...
 3900 CONTINUE
C
C     OPTION NUMBER 30 -- BRSHPREP                             BRSHPREP
C
      CALL ESPRIN(492,IDSDAT,IRECNT,KEYWRD,ARRAY,LNOTBK,JOSTND,KARD)
      GOTO 10
