      ...
      IMPLICIT NONE
C----------
C  $Id: prtexm.f 767 2013-04-10 22:29:22Z rhavis@msn.com $
C----------
C
...
C----------
 ...
 9008 FORMAT(74X,I3,6X,F4.1,4X,F8.0,5X,F5.0,5X,F5.1,1X,F7.0)
...
C----------
 ...
 9012 FORMAT(/1X,I4,' **',39X,'(',I3,' YRS)'/)
   50 CONTINUE
     ...
     >                     DGIO(I),PCTIO(I),NINT(PRBIO(I)),I=1,6)
c
c     drop 1 digit of precision (relative to nonmetric) to allow
c     6 digits (I8)
c
