      ...
      IMPLICIT NONE
C----------
C  $Id: disply.f 767 2013-04-10 22:29:22Z rhavis@msn.com $
C----------
...
C----------
   ...
   91 CONTINUE
      ...
      QDBHAT(IKNT)=ORMSQD
      ISDIAT(IKNT)= SDIBC/GROSPC + 0.5
   92 CONTINUE
      ISDI(IKNT)=SDIBC/GROSPC + 0.5
