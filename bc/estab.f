      ...
      IMPLICIT NONE
C----------
C  $Id: estab.f 767 2013-04-10 22:29:22Z rhavis@msn.com $
C----------
COMMONS
      INCLUDE 'PRGPRM.F77'
      INCLUDE 'ARRAYS.F77'
...
C
     ...
     &  MYACTS/430,431,491,493,492/,NOFSPE/MAXSP/
C
...
C
    ...
    5 CONTINUE
C
C     IF NOT THE FIRST TALLY, CANCEL MECH, BURN, BRUSH PREP'S IN THIS CYCLE.
C
      IF(NTALLY.GT.1) THEN
        CALL OPFIND (3,MYACTS(3),NTODO)
        IF(NTODO.GT.0) THEN
          DO 6 ITODO=1,NTODO
          CALL OPDEL1 (ITODO)
    6     CONTINUE
