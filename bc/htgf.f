      ...
      IMPLICIT NONE
C----------
C  $Id: htgf.f 799 2013-04-26 16:09:19Z drobinsonessa@gmail.com $
C----------
...
C     MODIFY MULTIPLIERS TO ALLOW DIAMETER RANGE FOR MULTIPLIER
...
C       END OF TREE LOOP.  PRINT DEBUG INFO IF DESIRED.
        ...
        IF (DEBUG) THEN
          HTNEW=HT(I)+HTG(I)
          WRITE (JOSTND,9000) HTG(I),D,WK1(I),I,ISPC
 9000     FORMAT(' 9000 HTGF, HTG=',F8.4,' D =',F8.4/' WK1=',F8.4,
...
C       CHECK FOR SIZE CAP COMPLIANCE.
 ...
 9001   FORMAT( 'IN HTGF: UPPER HTG =',F8.4,' LOWER HTG =',F8.4)
