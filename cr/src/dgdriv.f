      ...
      IMPLICIT NONE
C----------
C CR $Id: dgdriv.f 1399 2015-01-09 00:44:58Z tod.haren $
C----------
...
C----------
      ...
      INTEGER NUMCAL(MAXSP),ITRIPL
      REAL PSIGSQ(MAXSP)
      INTEGER IREFI,N,KOUT,K,ISPEC,KK,I,ISPC,I1,I2,I3,ITRIPU,ISI
      REAL SCALE,CORNEW,DEV,DEVSQ,XNOB,FN,SPOPN,SPOPX,SNP,SNX,SNY
      REAL SNXY,SNXX,SNYY,PN,PX,P,BARK,EDDS,TERM,RESLOG,WC,BPOPX
      REAL BNX,BNY,CSNXY,CSNXX,SLOP,RATIO,SDPRED,DIST,REGCOR,RX,RN
      REAL SIGMR1,CORI,PVAR,TEMP,Z,VTEMP
      REAL VARYP2,EVARP2,SSIGMA,RHO,RHOCP,XDGROW,FRL,FRM,FRU
      REAL CORMLT,WKI,D,BRATIO,DDS,DSQ,GDIF,GLIM,FRMT
      REAL PVMLT,CORR,SFINT,VARYP1,EVARP1,SIG1,DN,DX,BKPT,SVAR,BACHLO
      CHARACTER DAT*10,TIM*8,SPEC*2,VVER*7,REV*10
      REAL RNPAR
C----------
C  SET PSIGSQ TO AVG VALUE FROM INLAND EMPIRE -- NO DATA TO SET RIGHT.
C----------
      DATA PSIGSQ/ MAXSP*0.07/
C-----------
C  CHECK FOR DEBUG.
C-----------
...
C  IS LESS THAN ZERO, OR DBH IS LESS THAN 0.5 INCHES, THE RECORD
