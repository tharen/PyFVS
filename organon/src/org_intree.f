      SUBROUTINE ORG_INTREE (ORGINP,NTREES,LKECHO,VER)
      use htcal_mod
      use plot_mod
      use arrays_mod
      use estree_mod
...
C
C  THIS ROUTINE READS THE ORGANON TREE DATA FROM THE .INP FILE AND
...
C
    ...
    9 CONTINUE
C
C  PROCESS 1ST LINE OF THE .INP FILE
C
...
C
C  PROCESS 2ND, 3RD, AND 4TH LINES OF THE .INP FILE
C  IGNORE THE 19TH POSITION
C
  ...
  406 FORMAT(19F5.2)
      ...
      END DO
C
C  PROCESS 5TH LINE OF THE .INP FILE
C
