      ...
      implicit none
C----------
C  **REGENT--ON    DATE OF LAST REVISION:  01/13/12
C----------
...
C  THAT ARE LESS THAN 12CM DBH,
C  AND THE DBH INCREMENT MODEL IS APPLIED TO TREES THAT ARE LESS
C  THAN 12CM DBH.  FOR TREES THAT ARE GREATER THAN 8CM
...
C----------
      ...
      ! new xmin/xmax = 8/12cm - September 2011, Penner 2010 model
...
C----------
      CALL BALMOD(ISPC,D,BA,RMSQD,GMOD,DEBUG)
      IF(DEBUG)WRITE(JOSTND,*)' AFTER BALMOD GMOD,HT,AVH= ',GMOD,HT(I),
     & AVH
C      GMOD = (GMOD+1.0)/2.0
      RELHTA=0.
      IF(AVH .GT. 0.)RELHTA=MIN((HT(I)/AVH),1.0)
