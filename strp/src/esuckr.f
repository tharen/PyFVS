      ...
      implicit none
C----------
C  **ESUCKR--STRP   DATE OF LAST REVISION:  12/16/2014
C
...
C----------
      ...
      INTEGER NUMSPR,I,ICL,ISSP,IPLOT,ISPSTO,II,MXRR,J,IIRGT,MXTODO
...
C----------
      NSPRT = 0
      CALL NSPREC(VVER(:2),ISSP,NSPRT,DSTMP)
      NUMSPR = NSPRT
