      ...
      IMPLICIT NONE
C----------
C AK $Id: dgdriv.f 1399 2015-01-09 00:44:58Z tod.haren $
C----------
...
C----------
      ...
      LOGICAL DEBUG
      REAL MISDGF
      INTEGER ISI,IREFI,N,K,ISPEC,KK,KOUT,I,ISPC,I1,I2,I3
      INTEGER ITRIPU,ITRIPL,NUMCAL(MAXSP)
      REAL SCALE,CORNEW,DEV,DEVSQ,XNOB,FN,SPOPN,SPOPX,SNO,SNX,SNY
      REAL SNXY,SNXX,SNYY,DN,DX,PN,PX,P,BARK,EDDS,TERM,RESLOG,WC
      REAL BPOPX,BNX,BNY,CSNXY,CSNXX,SLOP,RATIO,SDPRED,DIST,REGGOR
      REAL RX,RN,SIGMR1,SVAR,CORI,PVAR,TEMP,Z,VTEMP,PSIGSQ(MAXSP)
      REAL CORTEM(MAXSP)
      REAL STDRAT(MAXSP),PVMLT,CORR,SFINT,VARYP1,EVARP1,SIG1,VARYP2
      REAL EVARP2,SSIGMA,RHO,RHOCP,XDGROW,FRL,FRM,FRMT,FRU,CORMLT,WKI,D
      REAL BRATIO,DDS,DSQ,FMRT,SNP,REGCOR,BACHLO
      CHARACTER DAT*10,TIM*8,SPEC*2,VVER*7,REV*10
      REAL RNPAR
      DATA PSIGSQ/
     &  0.0408,  0.0586,  0.1556,  0.0970,  0.0858,  0.1433,
     &  0.0636,  0.0970,  0.0970,  0.0809,  0.0809,  0.0636,  0.0858/
C-----------
C  CHECK FOR DEBUG.
C-----------
