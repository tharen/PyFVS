...
C----------
      LOGICAL DEBUG
      INTEGER SMMAPS(13)
      INTEGER MAPLOC(7,13),ISPC,I1,I2,I3,I,INDXS,IASP,MAPDSQ(7,13)
      REAL DGHAH(13),DGBA(13),DGLNBA(13),OBSERV(13),SMDS(3),SMFOR(4,3)
      REAL SMDBAL(3),SMSL2(3)
      ...
      REAL DDSL,DDSS,XWT,XPPDDS,SSITE,TEMEL,DGSLSQ(13),DGSLOP(13)
      REAL DGCASP(13),DGSASP(13),DGEL2(13),DGEL(13)
      REAL DGDS(4,13),DGFOR(6,13),DGSITE(13),DGDBAL(13)
      REAL DGCRSQ(13),DGCR(13),DGBAL(13),DGLD(13),DIAM(MAXTRE),BRATIO
      REAL CONST
C----------
C SPECIES ORDER
