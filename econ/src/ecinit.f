...
!    Initialize volume accumulators.  Set here 1st for use in echarv.f, then re-set each cycle in eccalc.f
      dbhSq     = 0.0
...
! Initialize indvidual tree and log accumulatiors. Set heare 1st for use in ecvol.f, then reset by tree in ecvol.f
      logBfVol  = 0.0; logDibBf   = 0.0; logFt3Vol  = 0.0                !Log arrays (1:MAXTRE, 1:MAX_LOGS)
      logDibFt3 = 0.0

!    Initialize revenue arrays recieving their value from keyword entries
