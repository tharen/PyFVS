      ...
      IMPLICIT NONE
C----------
C SN $Id: dgdriv.f 1399 2015-01-09 00:44:58Z tod.haren $
C----------
...
C    PSIGSQ -- MEAN VALUE FROM NI VARIANT
C----------
      EXTERNAL RANN
      LOGICAL DEBUG
      REAL MISDGF
      ...
      INTEGER KK,ISPEC,K,KOUT
      INTEGER I,ISPC,I1,I2,I3,ITRIPU,ITRIPL,ISI,IREFI,N
      REAL VTEMP,Z,TEMP,PVAR,CORI,SVAR,SIGMR1,RN,RX,REGCOR,DIST,SDPRED
      REAL RATIO,SLOP,CSNXX,CSNYY,BNY,BNX,BPOPX,WC,RESLOG,TERM,EDDS
      REAL BARK,P,PX,PN,DX,DN,SNYY,SNXX,SNXY,SNY,SNX,SNP,SPOPX
      REAL SPOPN,FN,XNOB,DEVSQ,DEV,CORNEW,SCALE,FRMT,DSQ,DDS,D,WKI
      REAL CORMLT,FRU,FRM,BACHLO,CSNXY,BRATIO,FRL,XDGROW,RHOCP,RHO
      REAL SSIGMA,EVARP2,VARYP1,VARYP2,EVARP1,SIG1,SFINT,CORR,PVMLT
      CHARACTER DAT*10,TIM*8,SPEC*2,VVER*7,REV*10
      REAL RNPAR
      DATA PSIGSQ/ 90*0.089827273 /
...
C----------
      ...
      WRITE(JOSTND,9000) I,ISPC,D,HT(I),WKI,DG(I),FRM, MISDGF(I,ISPC)
 9000 FORMAT('IN DGDRIV, I=',I4,', ISPC=',I3,', DBH=',F7.2,
     &       ', HT=',F7.2,', EXP.GR.=',F7.4,', PRED.GR.=',F7.4,
     &       ', FRM=',F7.4,' MISDGF= ',F7.4)
      GO TO 40
C----------
...
C----------
      IF(DEBUG) WRITE(JOSTND,157) I,DG(I),BARK,WK3(I),WK2(I),SCALE
  157 FORMAT('IN DGDRIV 157, I ,DG(I), BARK, WK3(I), WK2(I), SCALE=',/
     1        I5,7F10.3)
C
...
C----------
      ...
      COR(ISPC)= WC * CORI
      IF (DEBUG)WRITE(JOSTND,9009)ISPC,COR(ISPC),SVAR,PVAR,TEMP,WC,CORI
 9009 FORMAT ('IN DGDRIV 9009,ISPC,COR(ISPC),SVAR,PVAR,TEMP,WC,CORI=',/
     1  I5,7F10.3)
      GO TO 193
  190 CONTINUE
C----------
