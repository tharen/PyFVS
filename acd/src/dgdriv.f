      ...
      IMPLICIT NONE
C----------
C ACD $Id: dgdriv.f 1399 2015-01-09 00:44:58Z tod.haren $
C----------
...
C----------
      ...
      REAL RATIO,SLOP,CSNXX,CSNXY,BNY,BNX,BPOPX,WC,RESLOG,TERM,EDDS
      REAL BARK,P,PX,PN,DX,DN,SNYY,SNXX,SNXY,SNY,SNX,SNP,SPOPX,SPOPN
      REAL FN,XNOB,DEV,DEVSQ,CORNEW,SCALE,FRMT,DSQ,DDS,S,WKI,CORMLT
      REAL FRU,FRM,BACHLO,D,BRATIO,FRL,XDGROW,RHOCP,RHO,SSIGMA,EVARP2
      REAL VARYP1,VARYP2,EVARP1,SIG1,SFINT,CORR,PVMLT
      INTEGER I,ISPC,I1,I2,I3,ITRIPU,ITRIPL,ISI,IREFI,N
      CHARACTER DAT*10,TIM*8,SPEC*2,VVER*7,REV*10
      REAL RNPAR
      DATA PSIGSQ/ 108*0.0898 /
C-----------
C  CHECK FOR DEBUG.
C-----------
...
C----------
 ...
 9194   FORMAT(T27,'LARGE TREE DG: SPECIES = ',I2,' (',A3,
