      ...
      IMPLICIT NONE
C----------
C  $Id: cuts.f 767 2013-04-10 22:29:22Z rhavis@msn.com $
C----------
...
C             233,234,235,236,248
C----------
      CALL OPFIND (19,MYACTS(2),NTODO)
      IF (DEBUG) WRITE (JOSTND,9020) NTODO,(MYACTS(I),I=2,20)
 9020 FORMAT (' IN CUTS:  NTODO=',I4,'; MYACTS=',19I5)
      IF (NTODO.LE.0) THEN
         TCUT=0.0
         GO TO 1950
      ENDIF
...
C  ZERO OUT WK2 FOR REMAINING TREES.
C----------
