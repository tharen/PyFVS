      ...
      IMPLICIT NONE
C----------
C  $Id: initre.f 1127 2013-12-16 20:06:44Z tod.haren $
C----------
C
...
C----------
     ...
     &         IGSP,DBHMIN(IGSP),STMP(IGSP),FRMCLS(IGSP)
        ELSE
          IF(LKECHO)WRITE(JOSTND,4535) KEYWRD,KARD(2)(1:ILEN),
     &      IGSP,DBHMIN(IGSP),TOPD(IGSP),STMP(IGSP),FRMCLS(IGSP)
        ENDIF
...
C----------
 ...
 4622   FORMAT (T22,'TOP DIAMETER=',F6.2)
