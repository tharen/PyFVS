      ...
      IMPLICIT NONE
C----------
C  $Id: fortyp.f 994 2013-07-26 18:38:53Z rhavis@msn.com $
C----------
...
C----------
     ...
     &     MTNHMLK,MXDHWD,NOBLFIR,NROAK,NWHCDR
      REAL QOAK2,UPLAND,P1,P2,P3,EIGHTY,FIFTN,TEN,FIVE,QUATR,HALF,PCOND
      ...
      REAL EUCLPT,PALONIA,EXHWDS,PALM,TROHPWDS,PACMDRN,OTHWHWD,GNTCHNK
...
C
     ...
     &'ISZCL,ISTCL = ',FIATYP,SDIFIA,ISZCL,ISTCL
C
C
      RETURN
      END
