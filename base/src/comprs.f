      ...
      IMPLICIT NONE
C----------
C  $Id: comprs.f 767 2013-04-10 22:29:22Z rhavis@msn.com $
C----------
C
...
C
      ...
      WRITE (JOSTND,201)
  201 FORMAT (//' CLASS TREE#   SCORES',23X,'PROB  MORT(WK2) IMC ISP ',
     >      ' ICR ITRUNC NORMHT  DBH     HT    DBH   DG     CFV ITRE')
      I1=1
      TSSWC=0.
      DO 207 I=1,NCLAS
      SSWC=0.
