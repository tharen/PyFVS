...
C----------
C FOR SPECIES FROM THE WC VARIANT, THE HT1 AND HT2 COEFFICIENTS ONLY
C APPLY TO TREES GREATER THAN 5.0 INCHES.
C----------
...
C
      ...
      ENDIF
C----------
C  IF D<5.0 AND THE SPECIES IS FROM THE WC VARIANT, USE WC SMALL TREE
C  DUBBING FUNCTION, OTHRWISE USE THE WYKOFF EQUATION.
C----------
...
C----------
C SMALL PP & OS USE A DIFFERENT LOGIC. RJ 7-26-88
C----------
      IF((ISPC.EQ.10 .OR. ISPC.EQ.17) .AND. D.LT.3.0)THEN
