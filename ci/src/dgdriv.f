      ...
      IMPLICIT NONE
C----------
C CI $Id: dgdriv.f 1399 2015-01-09 00:44:58Z tod.haren $
C----------
...
C----------
     ...
     &  0.0586,  0.0586,  0.1433,    0.07,  0.0898,
     &  0.0586,    0.07,  0.0858,    0.07/
C-----------
C  CHECK FOR DEBUG.
C-----------
...
C----------
C  17=CW AND 19=OH LOGIC FROM CR VIA IE
...
C----------
      ...
      DX=0.0
C----------
C  17=CW AND 19=OH USE BREAKPOINT DIAMETER OF 1.0
C----------
      SELECT CASE (ISPC)
      CASE(17,19)
        BKPT = 1.0
