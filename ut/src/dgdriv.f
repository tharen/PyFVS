      ...
      IMPLICIT NONE
C----------
C UT $Id: dgdriv.f 1399 2015-01-09 00:44:58Z tod.haren $
C----------
...
C----------
      ...
      REAL SNXX,SNYY,DN,DX,PN,PX,P,BARK,EDDS,TERM,RESLOG,WC,BPOPX,BNX
      REAL BNY,CSNXY,CSNXX,SLOP,RATIO,PVMLT,CORR,SFINT,VARYP1,VARYP2
      REAL EVARP1,EVARP2,SSIGMA,RHO,RHOCP,XDGROW,FRL,FRM,FRU,CORMLT,WKI
      REAL D,DDS,DSQ,FRMT,BRATIO,SIG1,SDPRED,REGCOR,RX,RN,SIGMR1
      REAL SVAR,CORI,PVAR,TEMP,Z,BACHLO,VTEMP,DIST,BKPT
      INTEGER I,ISPC,I1,I2,I3,ITRIPU,ITRIPL,KOUT,K,ISPEC,KK
      REAL MISDGF,GDIF,GLIM
...
C----------
      DATA PSIGSQ/
     &  0.0408,  0.0586,  0.1556,  0.0970,  0.0970,
     &  0.1433,  0.0636,  0.0970,  0.0970,  0.0636,
     &    0.07,    0.07,    0.07,    0.07,    0.07,
     &    0.07,    0.07,    0.07,    0.07,  0.0898,
...
C----------
C  FOR SPECIES WITH SURROGATE EQUATIONS FROM THE CR VARIANT,
