...
C ----------------------------------------------------------------------
      SUBROUTINE R8CLARK(VOLEQ,FORST,STUMP,MTOPP,MTOPS,DBHOB,
...
C USING R9 ROUTINE
      ...
      END
C ----------------------------------------------------------------
      SUBROUTINE R8LOGDIB(VOLEQ, FORST, DBHOB, HTTOT, UPSHT1, 
     &           NUMSEG,TRIM,STUMP,BOLHT, LOGLEN, LOGDIA,ERRFLAG)
      USE CLKCOEF_MOD
...
!...  Parameters
      CHARACTER*10 VOLEQ
      CHARACTER*2 FORST
      INTEGER NUMSEG, I, ERRFLAG
      REAL    TRIM, STUMP, LOGLEN(20), LOGDIA(21,3), BOLHT(21)
      REAL    DIB,DBHOB,HTTOT,UPSHT1
