...
call f2py -h pyfvs%1.pyf -m pyfvs%1 --overwrite-signature %pymod_source% > ..\f2py_%1.log 2>&1
call f2py -c -lodbc32 --fcompiler=gnu95 --compiler=mingw32 ./pyfvs%1.pyf libFVS%1_static.a >> ..\f2py_%1.log 2>&1
