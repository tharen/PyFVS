      SUBROUTINE SCOMRT(TOKILL,DEBUG,SUMKIL)
      use multcm_mod
      use plot_mod
      use arrays_mod
      use estree_mod
      ...
      implicit none
C----------
C  **SCOMRT--SO    DATE OF LAST REVISION:  09/16/10
C----------
...
C----------
      DATA VARADJ/
     &  0.7,  0.75,  0.7,  0.55,  0.5,  0.65,  0.9,  0.6,  0.6,  0.85,
     &  1.1,  0.55, 0.55,   0.5,  0.7,   0.8,   1.,  0.5,  0.5,   0.5,
     &   1.,   0.9,  0.7,   1.3, 0.85,   1.1,   1.,  1.3,  0.8,   1.1,
     &  1.1,   0.7,   1./
C----------
