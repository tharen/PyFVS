...
!----------
      ...
      COMMON /VARCOM/ AA,BB,IABFLG,B0ACCF,B1ACCF,B0BCCF,B1BCCF,B0ASTD, &
            B1BSTD,HTT1,HTT2,BB0,BB1,BB2,BB3,BB4,BB5,BB6,BB7,          &
            BB8,BB9,BB10,BB11,BB12,BB13,PTBALT,PTBAA,ISTAGF,           &
            MAXSDI,CEPMRT,SLPMRT,TPAMRT,                               &
            LBAMAX,LFLAGV,LFIXSD,ISILFT,QMDMSB,SLPMSB,CEPMSB,EFFMSB,   &
            DLOMSB,DHIMSB,MFLMSB,IBASP
!----------
