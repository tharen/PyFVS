...
!----------
      ...
      LOGICAL LDUBDG,LRCOR2,LFLAG,LDCOR2,LDGCAL(MAXSP),LHTDRG(MAXSP), &
            ...
            LBVOLS,LFIA,LZEIDE,LEAVESP(MAXSP)
      INTEGER ICCODE,ICFLAG,ICL1,ICL2,ICL3,ICL4,ICL5,ICL6,ICYC,       &
            ...
            ITHNPI,ITHNPN,ITHNPA,NPTGRP,IPTGRP(30,52),GLOCCC
...
!   GLOCCC  -- INDICATOR VARIABLE FOR WHETHER THE USER WANTS TO USE THE
!              SPECIFIED OVERLAP COEFFICIENT IN CCADJ FOR A THINCC TARGET
