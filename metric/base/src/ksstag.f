      ...
      IMPLICIT NONE
C----------
C  $Id: ksstag.f 767 2013-04-10 22:29:22Z rhavis@msn.com $
C----------
C
...
C     THE MINIMUM TREES/HA THAT MUST BE EXCEEDED FOR A STAND
...
C     RATHER THAN STAND INITIATION
     ...
     >  TPAMIN/HAtoACR,PCTSMX
  200 FORMAT (/1X,A8,'   STAND STRUCTURAL CLASSES WILL BE ',
     >  'COMPUTED.'/T13,
     >  'OUTPUT PRINTING CODE = ',F3.0,' (0=NO OUTPUT, 1=PRINT)'/T13,
     >  'THE PERCENTAGE OF A TREE HEIGHT THAT A GAP MUST EXCEED =',
     >   T77,F6.1/T13,
     >  'THE DBH BREAK BETWEEN SEEDLING/SAPLINGS AND ',
     >  'POLE-SIZED TREES =',T77,F6.1/T13,
