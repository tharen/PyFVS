      ...
      IMPLICIT NONE
C----------
C  $Id: sstage.f 767 2013-04-10 22:29:22Z rhavis@msn.com $
C----------
C
...
C     COVER CALCULATIONS ABOVE).
     ...
     >     MAXTRE,MAXSP,DBHS1,IHTS1,IHTSS1,IHTLS1,ICRBS1,MSP1,MSP2)
      IF (MSP1.GT.0) SP11 = JSP(MSP1)
      IF (MSP2.GT.0) SP21 = JSP(MSP2)
     ...
     >     MAXTRE,MAXSP,DBHS2,IHTS2,IHTSS2,IHTLS2,ICRBS2,MSP1,MSP2)
      IF (MSP1.GT.0) SP12 = JSP(MSP1)
      IF (MSP2.GT.0) SP22 = JSP(MSP2)
     ...
     >     MAXTRE,MAXSP,DBHS3,IHTS3,IHTSS3,IHTLS3,ICRBS3,MSP1,MSP2)
      IF (MSP1.GT.0) SP13 = JSP(MSP1)
      IF (MSP2.GT.0) SP23 = JSP(MSP2)
...
C     SET THE IOSTR, WHICH IS USED BY STRSTAT, AN EVENT MONITOR FUNCTION.
     ...
     >  INT(IHTSS1*FTtoM),
     >  INT(ICRBS1*FTtoM),
     >  ICRCV1,SP11,SP21,IS1OK,
     >  DBHS2*INtoCM,
     >  INT(IHTS2*FTtoM),
     >  INT(IHTLS2*FTtoM),
     >  INT(IHTSS2*FTtoM),
     >  INT(ICRBS2*FTtoM),
     >  ICRCV2,SP12,SP22,IS2OK,
     >  DBHS3*INtoCM,
     >  INT(IHTS3*FTtoM),
     >  INT(IHTLS3*FTtoM),
     >  INT(IHTSS3*FTtoM),
