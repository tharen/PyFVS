...
C.... OUTPUT FOR PSTUMP KEYWORD
      ...
      IF(LKECHO)WRITE(JOSTND,302) KEYWRD, ARRAY(2), PPUSH
...
C.... IN.  CHECK THAT ONLY 100, AT MOST CENTERS ARE READ IN
  ...
  505    FORMAT (3F7.1)
         ...
         IF(LKECHO)WRITE(JOSTND,507) IC, DIMEN
  ...
  506    CONTINUE
         ...
         IF(LKECHO)WRITE(JOSTND,508) IC,DIMEN
