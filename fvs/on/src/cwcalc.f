      ...
      IMPLICIT NONE
C----------
C  **CWCALC--ON   DATE OF LAST REVISION:   07/11/08
C----------
...
C
      ...
      CHARACTER CWEQ*5
	CHARACTER*4 JSP2(MAXSP)
      REAL D, CW, HI, HILAT, HILONG, HIELEV,MIND,CR,OMIND
      REAL P,H
      DATA MIND/5./,OMIND/3./
C
C     FOR COMPLIANCE WITH US CROWN WIDTH EQUATIONS, THE 2-CHAR US SPECIES CODES
C     ARE USED HERE, RATHER THAN THE 2-CHAR CDN CODES
C
      DATA JSP2    /'JP ','SC ','RN ','RP ','WP ','WS ','NS ','BF ',
     &  'BS ','TA ','WC ','EH ','OS ','RC ','BA ','GA ','CW ','SV ',
     &  'RM ','BC ','AE ','RL ','RE ','YB ','BW ','SM ','BM ','AB ',
     &  'WA ','WO ','SW ','BR ','CK ','RO ','BO ','NP ','BH ','PH ',
     &  'SH ','BT ','QA ','BP ','PB ','CH ','BN ','WN ','HH ','BK ',
     &  'NC ','BE ','ST ','MM ','AH ','AC ','HB ','DW ','HT ','AP ',
     &  'BG ','SY ','PR ','CC ','PL ','WI ','BL ','DM ','SS ','MA ',
     &  'JP ','WP ','WS ','BS '/
C----------
