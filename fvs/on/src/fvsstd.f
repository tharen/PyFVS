...
C----------
      ...
      REAL PDBHI,BRATIO,PHTI,DUMSDI,CF2CRD
      DIMENSION CLAB1(2)
...
C     as a conversion.
     ...
     >  IDMR,PCT(I),IPTBAL,CFV(I)*CF2CRD,WK1(I)*CF2CRD,BFV(I),ICDF,IBDF,
     >  ((ITRUNC(I)+5)/100),PDBHI,PHTI,
     >  PTOCFV(I)*CF2CRD,PMRCFV(I)*CF2CRD,PMRBFV(I),NCFDEF(I),
     >  NBFDEF(I),YRDLOS(I),((NORMHT(I)+5)/100),ABIRTH(I),IPVEC(ITRE(I))
