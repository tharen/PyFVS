CODE SEGMENT PRGPRM
C----------
C  **PRGPRM--ON   DATE OF LAST REVISION:  04/19/07
C----------
C
C     PARAMETERS FOR THE PROGNOSIS MODEL ARE:
C
      INTEGER   MAXTRE,MAXTP1,MAXPLT,MAXSP,MAXCYC,MAXCY1,MAXSTR
      PARAMETER (MAXTRE=3000)
      PARAMETER (MAXTP1=MAXTRE+1)
      PARAMETER (MAXPLT=200)
      PARAMETER (MAXSP =72)
      PARAMETER (MAXCYC=40)
...
C			  ADDED 4 NEW PLANTATION SPECIES FOR THE ONTARIO VARIANT.
