     ...
     &           JOSTND,DEBUG,IHT1,IHT2)
      IMPLICIT NONE
C----------
C  **NBOLT--ON   DATE OF LAST REVISION:  07/11/08
C----------
...
C----------
     ...
     &  25*6.4301,16.934,16.281,31.957,20.038/
      DATA B2/
     ...
     &  2*1.3380,1.0000,25*1.3380,2*1.0,1.7020,1.2909/
      DATA B4/
     ...
     &  2*.73385,.76498,25*.73385,.77792,.86833,.68967,.57343/
      DATA B6/
     ...
     &  2*.08228,.11046,25*.08228,.12902,.23316,.162,.10159/
C----------
