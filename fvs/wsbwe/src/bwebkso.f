...
C       WL is not actually present as a FVS species in the SO variant.
C    31-JAN-05 Lance David (FHTET)
C       Adapted from the SORNEC 11 specie to SORNEC 33 specie variant.
...
C     ****** IBWSPM IS MODIFIED FOR SO VARIANT
