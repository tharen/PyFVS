...
C----------
      DIMENSION TRFBMS(MAXTRE)
      DIMENSION BINT11(11), BCL11(11)
      DIMENSION BINT12(11), BCL12(11)
      DIMENSION BINT2(11)
      DIMENSION IBIOMP(MAXSP)
...
C     NI Was:       WP  WL  DF  GF  WH  RC  LP  ES  AF  PP  OT
C     CI Was:       WP  WL  DF  GF  WH  RC  LP  ES  AF  PP  OT
