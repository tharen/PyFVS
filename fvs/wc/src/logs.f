      ...
      IMPLICIT NONE
C----------
C  **LOGS--WC   DATE OF LAST REVISION:  05/19/08
C----------
C  ONLY DIFFERENCE FROM NI.SOURCE:LOGS.F77 IS THE MAPPING OF
C  THE 39 WC SPECIES TO COEFFICIENT INDEX 1
C
...
C
      ...
      INTEGER IMAP(MAXSP)
      REAL QTLN,TBV,FRAC,DU,AH,S1,HTM,Z1,DTOP,BVL,DIBAHI,H1,B1,B2
     ...
     & 0.95204, 0.92368, 0.89659, 0.95411, 0.94976, 0.95222/
      DATA IMAP  / MAXSP*1/
C     DATA IMAP  / 1, 2, 4, 5, 1, 3, 1, 1, 6, 1, 3/
C----------
