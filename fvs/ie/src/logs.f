      ...
      IMPLICIT NONE
C----------
C  **LOGS--NI23   DATE OF LAST REVISION:  04/01/08
C----------
...
C
      ...
      INTEGER IMAP(MAXSP)
      REAL SF(4,2)
      REAL BV,STMP,BDMIN,HT,DBH,TRIM,SLN,X,D,B2,B1
      REAL H1,DIBAHI,BVL,DTOP,Z1,HTM,S1,AH,HI,DU,FRAC,TBV,QTLN
...
C
     ...
     & 0.95204, 0.92368, 0.89659, 0.95411, 0.94976, 0.95222/
      DATA IMAP  / 1, 2, 4, 5, 1, 3, 1, 1, 6, 1, 3, 12*3/
C----------
