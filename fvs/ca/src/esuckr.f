      ...
      IMPLICIT NONE
C----------
C  **ESUCKR--CA   DATE OF LAST REVISION:  01/27/11
C----------
COMMONS
C
      INCLUDE 'PRGPRM.F77'
...
C
      ...
      REAL HTAVE,TPASUM,COUNTR,TPATOT,PREM,RSHAG,SPA,BACHLO,BX,AX
      REAL CRDUM,CW
C
      EXTERNAL ESRANN
      LOGICAL DEBUG
...
C----------
C  PACIFIC YEW (24) AND CALIFORNIA NUTMEG (47) SPROUT COUNT
C  IS CUT IN HALF
C----------
      IF((ISSP.EQ.24).OR.(ISSP.EQ.47))THEN
        NUMSPR=1
      ELSE
        NUMSPR=2
      ENDIF
