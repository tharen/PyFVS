      ...
      IMPLICIT NONE
C----------
C  **MORTS--AK   DATE OF LAST REVISION:  09/09/13
C----------
...
C----------
      INTEGER IDMFLG,ITODO,IP,KPOINT,KBIG,IGRP,IULIM,IG,IX,J
      INTEGER MYACTS(2),KNT,NTODO,I,NP,IACTK,IDATE,ISPCC,IPASS
      INTEGER ISPC,I1,I2,I3,IS,IPATH
      ...
      REAL RIP,X,PRES,VLOS,SUMTRE,TN,SD2SQN,DQ10N,KNT2,TNEW,BANEW,BADEAD
      REAL QMDNEW,ADJFAC,XMORE,TEMP,CREDIT,PRM(6),PMD(MAXSP),PMSC(MAXSP)
      REAL DQ0,SUMKIL,T,SD2SQ,P,D,BARK,BRATIO,G,CIOBDS,DQ10
      REAL DELTBA,CONST,TREEIT,TN10TMP
      REAL TMMSB,T85MSB,TMORE,TEMEFF,TPACLS,DBHEND
...
C----------
      ...
      IF(TN10 .GE. 0.1)THEN
        CALL SEAMRT(SUMTRE,DEBUG,SUMKIL)
      ENDIF
C----------
