      ...
      IMPLICIT NONE
C---------- 
C  **TMINIT--EM DATE OF LAST REVISION:  04/01/13
C---------- 
C     
...
C     FOR EASTERN MONTANA VARIANT THEY ARE :
C        IDFCOD - 3  (DF SPECIES CODE)
C        IGFCOD - 9  (Grand Fir (GF) SPECIES IS NOT REPRESENTED,
C                     SUBALPINE FIR (AF) IS IN THIS VARIANTS.
C
      IDFCOD = 3
      IGFCOD = 9
      LNPV2    = .FALSE.
