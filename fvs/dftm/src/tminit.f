      ...
      IMPLICIT NONE
C---------- 
C  **TMINIT--BM DATE OF LAST REVISION:  04/01/13
C  **TMINIT--NI
C  **TMINIT--SO
C  **TMINIT--UT
C  **TMINIT--IE
...
C     FOR BLUE MOUNTAINS (BM)
C         INLAND EMPIRE (NI / BASE)
C         SOUTHERN OR/NORTHEAST CA (SO)
C         UTAH (UT)
C       FVS VARIANTS THEY ARE :
C         IDFCOD - 3  (DF SPECIES CODE)
C         IGFCOD - 4  (GF/WF SPECIES CODE)
C
      IDFCOD = 3
      IGFCOD = 4
      LNPV2    = .FALSE.
