     ...
     1                 BTKFLG)
      IMPLICIT NONE
C----------
C  **BFVOL--NC     DATE OF LAST REVISION:   04/03/08
C
...
C----------
      ...
      INTEGER ITHT,ISPC,ID,ITD,IVTD,I,INC,NUMLOG,LAST
      REAL VMAX,BARK,BBFV,D2H,H,D,TSIZE,VT,HDRATA,DTOPK,HTRUNC,TD,DIB
      REAL FC,SMDOLD,XLOG,SMD,PLEFT,D1SQ,FACTOR,TLOG
      CHARACTER VVER*7
C
      DATA D2HBRK/
