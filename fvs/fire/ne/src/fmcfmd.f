      ...
      IMPLICIT NONE
C----------
C  **FMCFMD FIRE-NE-DATE OF LAST REVISION:  05/02/06
C----------
...
C  THIS IS CURRENTLY PART OF A STRIPPED-DOWN VERSION OF NE-FFE.
C  NO FUEL MODEL LOGIC CALIBRATION WAS DONE, SO WE JUST SET THE FUEL
C  MODEL TO FM 9, UNLESS HIGH FUEL LOADS LEAD TO A 10, 11, 12, OR 13
C----------
      EQWT(9) = 1.0
C----------
