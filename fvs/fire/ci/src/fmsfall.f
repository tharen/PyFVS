...
C----------
C  Reduce base rate for larger spruce and larger larch.
C  Marcot's eqn is too fast (20 yrs @ 15 in DBH vs 95 yrs @ 24 in DBH)
C----------

        IF (KSP .EQ. 8 .OR. KSP .EQ. 2) BASE = MAX(0.01, BASE * 0.32)
