...
C
C     Format statements 606, 711, 1321, 2921 (11F5.2) and 3963 (11I5)
C     are dependent on parameter MAXSP. If the number of species
C     (PRGPRM: MAXSP) changes, so must these.
C
C  Called By :
C     INITRE  [PROGNOSIS]
C
...
C              in the simulations. (RNH, May98)
C
C
