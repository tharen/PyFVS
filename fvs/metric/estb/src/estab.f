...
C
 ...
 7008   FORMAT(' TALLEST TREE',T15,20F5.2)
        WRITE (JOSTND,7016) (HTADJ(I),I=1,NOFSPE)
 7016   FORMAT(' ARRAY HTADJ',T15,20F5.2)
        WRITE (JOSTND,7017) (ICHOI(1,I),I=1,NOFSPE)
 7017   FORMAT(' ICHOI (ADV)',T15,20I5)
        WRITE (JOSTND,7018) (ICHOI(2,I),I=1,NOFSPE)
 7018   FORMAT('       (SUB)',T15,20I5)
        WRITE (JOSTND,7019) (STOMLT(I),I=1,NOFSPE)
 7019   FORMAT(' ARRAY STOMLT',T15,20F5.2)
      ENDIF
C
...
C     THE CALL TO RRESCP INSURES THAT THE SPACE REQUIRED IS BELOW THAT
C     NEEDED BY THE ROOT DISEASE MODEL.  RRESCP RETURNS THE MAXIMUM
C     NUMBER OF TREES THAT ROOT DISEASE CAN HANDLE.  IF RROT IS NOT
C     BEING RUN, MXRR IS RETURNED AS MAXTRE.  CALL ANESCP TO DO THE
C     SAME FOR THE ANNOSUS ROOT DISEASE MODEL AND RDESCP FOR VER. 3.0
C     OF THE WESTERN ROOT DISEASE MODEL.
C
      CALL RRESCP (MAXTRE,MXRR)
      CALL ANESCP (MXRR,  MXRR)
      CALL RDESCP (MXRR,  MXRR)
...
C
      ...
      ZRAND(ITRN)=-999.
C
      CALL RRESTB (ITRN,PROB(ITRN))
      CALL ANESTB (ITRN,PROB(ITRN))
