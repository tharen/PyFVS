      ...
      IMPLICIT NONE
C----------
C  **CRATET--LS    DATE OF LAST REVISION:  04/06/11
C----------
...
C----------
      ...
      CHARACTER*4 UNDER
      INTEGER I,J,II,ISPC,IPTR,I1,I2,I3,NH,JJ,IS,IM,IMR,K1,K2,K3,K4
      INTEGER KNT2(MAXSP),KNT(MAXSP)
      REAL BAT,BATREE,A1,A2,A3,A4,A5,A6,SUMX,H,D,BX,XX,YY,XN,HS,Q
      REAL SPCNT(MAXSP,3),B1(MAXSP),B2(MAXSP),B3(MAXSP)
      REAL B4(MAXSP),B5(MAXSP),B6(MAXSP),AX
...
C----------
  140 CONTINUE
      IF(DEBUG)THEN
      WRITE(JOSTND,9005) ISPC,IABFLG(ISPC)
