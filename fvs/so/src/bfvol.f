...
C----------
      ...
      REAL SMDIA(20),GLOGLN(20),COFBVS(MAXSP),HDRATM(100),D2HBRK(MAXSP)
      CHARACTER VVER*7
      INTEGER ITHT,ISPC,ID,ITD,IVTD,NUMLOG,I,INC,LAST
      REAL VMAX,BARK,BBFV,D2H,H,D,TSIZE,VT,HDRATA,TD,DIB,FC,SMDOLD,TLOG
      REAL XLOG,SMD,PLEFT,D1SQ,FACTOR,DTOPK,HTRUNC
C
      DATA D2HBRK/
