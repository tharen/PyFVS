...
*  mistletoe routines. This is the Interior Empire (NI, KT and EM).
*----------------------------------------------------------------------
*
...
*
*  Revision History :
*  02-MAY-2003 - Lance R. David (FHTET)
*     This routine created based on previously coded variant
*     routines and the Interim Dwarf Mistletoe Impact
...
C.... Mortality coefficients
     ...
     &   /0.0,  0.0,  0.0,
     &   0.01319,  -0.01627,  0.00822, ! DF (for WL)
...
C.... Check for debug.
   ...
   10 FORMAT(' Begin/end MISINTIE: Cycle = ',I5)
