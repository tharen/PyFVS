      ...
      IMPLICIT NONE
C----------
C  **CRATET--EM   DATE OF LAST REVISION:  05/16/11
C----------
...
C----------
      ...
      REAL AX,Q,SUMX,H,D,BX,XX,YY,XN,HS
C----------
C  SPECIES ORDER:
...
C  NOTE: IN THIS VARIANT, FINDAG CALLS POTHTG WHICH SETS ABIRTH(I)
C----------
     ...
     &              DEBUG)
C       IF(SITAGE .GT. 0.)ABIRTH(I)=SITAGE
      ENDIF
      ENDDO
C----------
C  CALL DGDRIV TO CALIBRATE DIAMETER GROWTH EQUATIONS.
