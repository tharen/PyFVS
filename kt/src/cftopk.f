      ...
      implicit none
C----------
C  **CFTOPK--KT     DATE OF LAST REVISION:  04/03/08
C----------
...
C----------
      LOGICAL LCONE
      INTEGER ITHT,ISPC
      REAL BARK,VMAX,VM,VN,H,D,VOLT,BEHRE,HTRUNC,PHT,DTRUNC,VOLTK
      REAL RCF,STUMP,DMRCH,HTMRCH,S3,VOLM
C---------
