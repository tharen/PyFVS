      ...
      IMPLICIT NONE
C----------
C CA $Id: dgdriv.f 1399 2015-01-09 00:44:58Z tod.haren $
C----------
...
C----------
      ...
      LOGICAL DEBUG
C
      INTEGER ISPC,I1,I2,I3,ITRIPU,ITRIPL,I
      REAL SFINT,VARYP1,EVARP1,SIG,VARYP2,EVARP2,SSIGMA,RHO,RHOCP
...
C
      ...
      REAL SCALE,CORNEW,DEV,DEVSQ,PN,PX,P,BARK,EDDS,TERM,RESLOG
...
C----------
C  DO NOT CALCULATE CORRECTION TERMS NOR CALIBRATE BAI MODEL
C  VARIANCE IF THERE ARE FEWER THAN FNMIN (DEFAULT=5.) OBSERVATIONS
C  FOR A SPECIES.
C----------
