      ...
      IMPLICIT NONE
C----------
C EM $Id: dgdriv.f 1399 2015-01-09 00:44:58Z tod.haren $
C----------
...
C----------
      ...
      REAL SSIGMA,RHO,RHOCP,XDGROW,FRL,BRATIO,BACHLO,BKPT,GDIF,GLIM
...
C----------
      DATA PSIGSQ/
     &  0.0408,  0.0586,  0.1556,  0.0586,  0.0970,    0.07,
     &  0.0636,  0.0970,  0.0970,  0.0636,    0.07,  0.1433,
     &    0.07,    0.07,    0.07,    0.07,  0.1433,  0.0858,
     &    0.07/
C-----------
C  CHECK FOR DEBUG.
C-----------
...
C----------
C  FOR GA, CW, BA, PW, NC, AND OH
C  LIMIT + RANDOM DRAW TO ONE THIRD THE GROWTH ESTIMATE
C  THIS IS FROM CR **DGDRIV**
C----------
      IF(ISPC.EQ.11 .OR. (ISPC.GE.13 .AND. ISPC.LE.16) .OR.
     &   ISPC.EQ.19)THEN
        GDIF = DG(I)-WKI
        GLIM = WKI*0.33
...
C----------
      ...
      DX=0.0
C----------
C  FOR GA, CW, BA, PW, NC, AND OH BREAKPOINT DIAMETER IS 1.0  
C  OTHERWISE IT IS 3.0
C----------
      BKPT = 3.0
      IF(ISPC.EQ.11 .OR. (ISPC.GE.13 .AND. ISPC.LE.16) .OR.
     &   ISPC.EQ.19)BKPT=1.0
