      ...
      implicit none
C----------
C  **BLKDAT--OC   DATE OF LAST REVISION:  06/17/15
C----------
C
...
C----------
C   BB_ ARRAYS HOLD SITE CURVE COEFFICIENTS BASED ON SITE SPECIES
C   THOSE IN:
...
C----------
      DATA BB0/      2500.,      69.91, -6.21693, -6.54707,        0.0,
     &             -0.0968,      6.413,    0.204,    0.375,      0.649,
     &  39*0. /
C
      DATA BB1/  -0.954038,    38.0202, 0.281176, 0.288169,    1.51744,
     &             0.02679,      0.322,   39.787,   31.233,     17.556,
     &  39*0. /
C
      DATA BB2/   0.109757,   -1.05213,  1.14354,  1.21297, 1.41512E-6,
     &         -0.00009309,         0.,       0.,       0.,         0.,
     &  39*0. /
C
      DATA BB3/   0.055818,   0.009557,       0.,       0., -0.0440853,
     & 44*0. /
C
      DATA BB4/  0.0079224, 101.842894,       0.,       0., -3.04951E6,
     & 44*0. /
C
      DATA BB5/ -0.0007338,  -0.001442,       0.,       0., 5.72474E-4,
     & 44*0. /
C
      DATA BB6/  0.0001977,   1.679259,   47*0. /
C
      DATA BB7/ 49*0. /
C
      DATA BB8/ 49*0. /
