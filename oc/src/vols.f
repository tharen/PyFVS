      ...
      implicit none
C----------
C  **VOLS--OC    DATE OF LAST REVISION:   06/17/15
C----------
C
...
C----------
      ...
      REAL*4      CFTD                 ! CUBIC VOLUME TOP DIAMETER, IN INCHES.
      REAL*4      CFSH                 ! CUBIC VOLUME, STUMP HEIGHT, IN FEET.
      REAL*4      LOGTD                ! SCRIBNER VOLUME, TOP DIAMETER, IN INCHES
      REAL*4      LOGSH                ! SCRIBNER VOLUME, STUMP HEIGHT, IN FEET
...
C----------
        ...
        CFTD  =   TOPD( ISP( I ) )    ! FT^3 VOL, MIN. TOP DIAMETER, IN INCHES.
        CFSH  =   STMP( ISP( I ) )    ! FT^3 STUMP HEIGHT, IN FEET.
        LOGTD =   BFTOPD( ISP( I ) )  ! LOG TOP DIAMETER, IN INCHES.
        LOGSH =   BFSTMP( ISP( I ) )  ! STUMP HEIGHT, IN FEET.
C----------
...
C-----------
      ...
      END IF
C-----------
C  ORGANON: END OF ORGANON CALL FOR CUBIC VOLUMES
C-----------
C
C----------
...
C----------
      IF( LORGVOLS ) THEN
C-----------
C  ORGANON: NULL TEMPORARY VOLUME VARIABLES
C-----------
        BFV(I)  = 0.
C----------
C  ORGANON: CALL THE ORGVOL.DLL VOLCALC SUBROUTINE
...
C-----------
      ...
      END IF
C-----------
C  ORGANON: END OF ORGANON CALL FOR BOARD FOOT VOLUMES
C-----------
