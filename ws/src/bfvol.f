     ...
     1                 BTKFLG)
      ...
      implicit none
C----------
C  **BFVOL--WS   DATE OF LAST REVISION:   05/09/12
C----------
C
...
C----------
C  DATA STATEMENTS
C  OS COEFFICIENTS FOR LP, WB, KP, FP, CP, LM, GP, WE, WJ, UJ, AND CJ
C  OH COEFFICIENTS USED FOR MC
C  USERS SHOULD BE SETTING THEIR OWN VALUES IF USING OPTIONS 2 OR 7
C----------
      DATA D2HBRK/
