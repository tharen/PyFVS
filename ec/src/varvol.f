      ...
      implicit none
C----------
C  **VARVOL--EC    DATE OF LAST REVISION:   09/09/12
C----------
C
...
C----------
      ...
      INTEGER IT,ITRNC,ISPC,INTFOR,IERR,IZERO,ERRFLAG,LOGST
