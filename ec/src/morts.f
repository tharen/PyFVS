      ...
      implicit none
C----------
C  **MORTS--EC   DATE OF LAST REVISION:  09/09/13
C----------
...
C  CONSTANTS.
C  SDI BASED MORTALITY IS ALWAYS USED. ADDITIONAL MORTALITY OCCURS WHEN
C  STAND BA EXCEEDS THE SPECIFIED MAXIMUM BA FOR THE SITE.  IF
...
C----------
      ...
      REAL PRM(6),PMSC(MAXSP),PMD(MAXSP)
C----------
...
C
C SHADE TOLERANCE LEVELS (SEE **HTGF** AND **VARMRT**):
...
C                  USE WP FOR WB, NF, GC, WO; OS FOR MH
...
C----------
     ...
     &    5.1677,    5.1677,    9.6943,    6.5112,    6.5112,
     &    5.1677,    5.9617,    5.1677,    5.5877,    5.9617,
     &    5.9617,    5.5877,    5.5877,    6.5112,    9.6943,
     &    5.9617,    5.9617,    6.5112,    5.5877,    5.9617,
     &    5.1677,    5.9617/
C
      DATA PMD/
     & -.0052485, -.0052485, -.0129121, -.0077681, -.0127328,
     & -.0077681, -.0340128, -.0127328, -.0077681,  -.005348,
     & -.0077681, -.0077681, -.0127328, -.0052485, -.0052485,
     & -.0077681, -.0340128, -.0077681,  -.005348, -.0340128,
     & -.0340128,  -.005348,  -.005348, -.0052485, -.0127328,
     & -.0340128, -.0340128, -.0052485,  -.005348, -.0340128,
     & -.0077681, -.0340128/
C----------
...
C
C***********************************************************************
C  THIS SECTION OF CODE IS NEEDED FOR SPECIES USING EC VARIANT LOGIC:
C
...
C----------
      CALL SDICAL(SDIMAX)
      IF(DEBUG)WRITE(JOSTND,*)'SDIMAX,BAMAX= ',
     &SDIMAX,BAMAX
