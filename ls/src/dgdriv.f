      ...
      IMPLICIT NONE
C----------
C LS $Id: dgdriv.f 1399 2015-01-09 00:44:58Z tod.haren $
C----------
...
C----------
      ...
      REAL SVAR,CORI,PVAR,TEMP,Z,BACHLO,VTEMP,DIST
      INTEGER I,ISPC,I1,I2,I3,ITRIPU,ITRIPL,KOUT,K,ISPEC,KK,ISI,IREFI,N
      CHARACTER DAT*10,TIM*8,SPEC*2,VVER*7,REV*10
      REAL RNPAR
      DATA PSIGSQ/ 68*0.0898 /
C-----------
C  CHECK FOR DEBUG.
C-----------
