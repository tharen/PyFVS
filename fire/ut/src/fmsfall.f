     ...
     &                   RSOFT,RSMAL,DFALLN)
      ...
      implicit none
C----------
C  **FMSFALL--FIRE--UT/CR/TT-DATE OF LAST REVISION: 11/30/09
C----------
C
...
C
      ...
      ENDIF
C
C     END OF BURN-YEAR CALCULATIONS
C
...
C
      ...
      ELSE
C
C       REDUCE BASE RATE FOR LARGER DOUGLAS-FIR & SPRUCES. MARCOT'S EQN IS
C       TOO FAST (32 YRS @ 20 IN DBH) VS. (100 YRS @ 20 IN DBH)
C
...
C     END OF >18IN DBH CALCULATIONS
C
      RETURN
      END
