      ...
      IMPLICIT NONE
C----------
C  FIRE $Id: fmin.f 968 2013-07-12 18:49:16Z rhavis@msn.com $
C----------
C
...
C
  ...
  415 FORMAT(/A8,'   THE BURN CONDITIONS REPORT WILL BE WRITTEN',
     &       ' WHEN A FIRE OCCURS.'
     &       /T12,'REPORTING WILL BEGIN IN DATE/CYCLE ',I4,
...
C
 ...
 1515 FORMAT(/A8,'   THE ALL FUELS REPORT WILL BEGIN PRINTING IN',
     &      ' DATE/CYCLE ',I4,','/T12,'FOR ',I4,
     &      ' YEARS USING ',I2,' YEAR INCREMENTS.')
C
      NPRMS = 2
      MYACT = 2515
...
C
 ...
 4410 FORMAT(/A8,'   MAIN CARBON REPORT WILL BEGIN PRINTING IN',
     &      ' DATE/CYCLE ',I4,','/T12,'FOR ',I4,
     &      ' YEARS USING ',I2,' YEAR INCREMENTS.')
...
C
 ...
 4510 FORMAT(/A8,T12,'HARVESTED PRODUCTS REPORT WILL BEGIN',
     &      ' PRINTING IN DATE/CYCLE ',I4,','/T12,'FOR ',I4,
     &      ' YEARS USING ',I2,' YEAR INCREMENTS.')
...
C                        OPTION NUMBER 47 -- CANFPROF
 ...
 4701   FORMAT(/A8,'   ***KEYWORD IS A STAND-LEVEL KEYWORD ONLY',
     ...
     &                            INT(PRMS(2))
 4710 FORMAT(/A8,'   THE CANOPY FUELS PROFILE TABLE WILL BE ',
     &      'OUTPUT STARTING IN DATE/CYCLE ',I4,','/T12,'FOR ',I4,
     &      ' YEARS USING ',I2,' YEAR INCREMENTS.')
...
C
 ...
 5115 FORMAT(/A8,'   THE DOWN WOOD VOLUME REPORT WILL BEGIN',
     &      ' PRINTING IN DATE/CYCLE ',I4,','/T12,'FOR ',I4,
     &      ' YEARS USING ',I2,' YEAR INCREMENTS.')
C
      NPRMS = 2
...
C
 ...
 5215 FORMAT(/A8,'   THE DOWN WOOD COVER REPORT WILL BEGIN',
     &      ' PRINTING IN DATE/CYCLE ',I4,','/T12,'FOR ',I4,
     &      ' YEARS USING ',I2,' YEAR INCREMENTS.')
C
      NPRMS = 2
