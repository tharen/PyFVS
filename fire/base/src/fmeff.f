     ...
     >                  PSBURN)
      IMPLICIT NONE
C----------
C  $Id: fmeff.f 767 2013-04-10 22:29:22Z rhavis@msn.com $
C----------
...
C         PUT THEIR CROWNS INTO CWD2B2 TO FALL AT APPROPRIATE TIMES IN
...
C            AND SHOULD ALSO BE PUT IN CWD2B2 POOLS. **FMSCRO** CAN DO THIS
